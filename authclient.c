...
int InitMySocket(void)
{
    ...
    // Ўаг 3 - установка соединени€, заполнение структуры sockaddr_in указание адреса и порта сервера
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
  ...
  //—оздаем на окне элементы управлени€
  ...
  //ѕомещаем окно в центр рабочего стола
  RECT rc,rcDesk;
